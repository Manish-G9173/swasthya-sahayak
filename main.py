...
# --- 🧠 INTELLIGENT MODEL SWITCHER (Fixed 404 Errors) ---
def get_response(prompt, img=None):
    # TIER 1: Try the Powerful "Gemini 2.5 Pro" (Best for Reasoning)
    try:
        ...
        # TIER 2: Fallback to "Gemini 2.5 Flash" (Best for Speed/Stability)
        try:
            ...
            return None, f"⚠️ Server Busy: {str(e2)}"
...
# --- 🎨 3. UI CSS (BRIGHTER BG + COLORFUL TITLE) ---
